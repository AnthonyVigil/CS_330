...
//window title
const char* const WINDOW_TITLE = "7-1 Assignment: Final Project [Anthony Vigil]";
...
// camera
Camera gCamera(glm::vec3(-2.0f, 3.0f, -3.0f), glm::vec3(0.0f, 1.0f, 0.0f), 45.0f, -25.0f);
...
glm::vec3 gSpotLightColor(0.8f, 0.8f, 0.8f);
glm::vec3 gSpotLightPosition(2.5f, 6.0f, -1.5f);
glm::vec3 gSpotLightScale(1.0f);

// Light 2
// Light color, position and scale
glm::vec3 gKeyLightColor(0.2f, 0.2f, 0.2f);
glm::vec3 gKeyLightPosition(-2.0f, 4.0f, -2.5f);
